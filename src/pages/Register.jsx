		...
		<div className="w-[70%] max-w-lg mx-auto mt-48 lg:mt-32 lg:mb-16">
			<form className={`bg-white rounded px-8 py-14 mb-4" ${ isDark ? 'shadow-bs02' : 'shadow-bs01'} `} onSubmit={registerUser}>
				...
				<div className="flex items-center justify-center">
					<button className="flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline tracking-wider" type="submit">
